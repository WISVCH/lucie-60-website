    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="basketLabel">Edit ticket</h4>
            </div>
            <form action="" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="max_hidden">Hide "tickets left" counter: </label>
                        <select name="max_hidden" id="max_hidden" class="form-control">
                            <option value="0">False</option>
                            <option value="1">True</option>
                        </select>
                    </div>
                ...
                <div class="modal-footer">
                    <input type="hidden" id="ticketKey" name="ticket_key">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <input type="submit" class="btn btn-danger" name="editTicket">
                </div>
            </form>
        </div>
    </div>
